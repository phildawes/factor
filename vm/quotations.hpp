...
struct quotation_jit : public jit {
	...
	quotation_jit(cell quot, bool compiling_, bool relocate_, factorvm *myvm)
		: jit(QUOTATION_TYPE,quot,myvm),
...
VM_ASM_API cell lazy_jit_compile_impl(cell quot, stack_frame *stack, factorvm *vm);
